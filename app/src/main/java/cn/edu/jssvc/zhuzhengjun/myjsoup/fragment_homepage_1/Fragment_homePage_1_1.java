...
public class Fragment_homePage_1_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_layout_home_page_1_1, container, false);
    }
    ...
    private void getData() {
        linksList.clear();
        meishiList.clear();
        HttpRequest.get("https://home.meishichina.com/show-top-type-recipe.html", new Response.Listener<String>() {
            @Override
    ...
    private void init() {
        listView = getActivity().findViewById(R.id.myFragment_1_1_listView);
        ...
        myXiala = getActivity().findViewById(R.id.myXialashuaxin_SwipeRefreshLayout_1);
    ...
    private void update() {
        i ++;
        if (i <= 10) {
            HttpRequest.get("https://home.meishichina.com/show-top-type-recipe-page-"+i+".html", new Response.Listener<String>() {
                @Override
                public void onResponse(String str) {
                    Document document = Jsoup.parse(str);
                    Elements links = document.select("div.ui_newlist_1 ul li");
