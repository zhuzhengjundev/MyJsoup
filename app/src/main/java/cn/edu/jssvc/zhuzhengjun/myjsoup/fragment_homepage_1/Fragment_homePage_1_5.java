...
public class Fragment_homePage_1_5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_layout_home_page_1_5, container, false);
    }
    ...
    private void init() {
        listView = getActivity().findViewById(R.id.myFragment_1_5_listView);
        ...
        myXiala = getActivity().findViewById(R.id.myXialashuaxin_SwipeRefreshLayout_5);
