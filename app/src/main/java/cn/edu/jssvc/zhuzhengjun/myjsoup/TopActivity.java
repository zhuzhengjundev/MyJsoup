...
public class TopActivity extends AppCompatActivity implements View.OnTouchListener{
    ...
    private void getData() {
        HttpRequest.get2(intent_link, new Response.Listener<String>() {
            ...
            public void onResponse(String str) {
                ...
                Glide.with(TopActivity.this)// 为当前Activity 加载图片
                ...
                HttpRequest.Bitmap(links.select("div.space_box_home div.recipDetail div.recipe_De_imgBox a.J_photo img").attr("src"), new Response.Listener<Bitmap>() {
                    @Override
                    public void onResponse(Bitmap bitmap) {
                        imageView_meishiImage.setImageBitmap(bitmap);
                    }
                }, null);
    ...
    private void init() {
        ...
        linearLayout_huadong = findViewById(R.id.mainTop_activityLinearLayout);
        textView_title = findViewById(R.id.mainTop_activity_title);
        textView_name = findViewById(R.id.mainTop_activity_name);
        textView_main_text = findViewById(R.id.mainTop_activity_meishi_text_main);
        imageView_touxiang = findViewById(R.id.mainTop_activity_touxiang);
        imageView_meishiImage = findViewById(R.id.mainTop_activity_meishi_image_main);
        linearLayout_huadong.setOnTouchListener(this);
        textView_cailiao_title = findViewById(R.id.mainTop_activity_meishi_cailiao_title);
        textView_cailiao_content = findViewById(R.id.mainTop_activity_meishi_cailiao_content);
        textView_buzhou_title = findViewById(R.id.mainTop_activity_meishi_buzhou_title);
        myListView = findViewById(R.id.mainTop_activity_MyListView);
        buzhouAdapter = new BuzhouAdapter(TopActivity.this, R.layout.main2_activity_listview_item, buzhouList);
